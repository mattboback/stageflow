...
import { getIssueScreenshotUrl, getPageOverviewUrl } from '$lib/report/screenshots';
...
describe('report screenshots', () => {
	...
	it('selects preferred page overview scanner when multiple exist', () => {
		...
		expect(getPageOverviewUrl(screenshots, 'page-1', ['axe', 'lighthouse'])).toBe(
			'https://example.com/axe.webp'
		);
	});
});
