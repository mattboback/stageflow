...
describe('buildDecisionPrompt', () => {
	...
	describe('basic structure', () => {
		...
		it('includes JSON schema instructions', () => {
			...
			expect(prompt).toContain('"type": "click|fill|select|hover|scroll|keyboard|wait|done|stuck"');
	...
	describe('input policy', () => {
		it('restricts input when inputValues provided', () => {
			...
			expect(prompt).toContain('You may only fill/select using one of these valueKey values:');
