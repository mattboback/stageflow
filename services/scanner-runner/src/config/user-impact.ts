...
const ruleImpacts: Record<string, UserImpact> = {
	'image-alt': {
		statement: 'Screen reader users cannot understand what this image shows or represents.',
	...
	'input-image-alt': {
		statement: 'Screen reader users cannot determine what action this image button performs.',
		affectedGroups: ['blind'],
		severity: 'blocking',
		userStory:
	...
	'object-alt': {
		statement: 'Screen reader users have no way to understand this embedded content.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'svg-img-alt': {
		statement: 'Screen reader users cannot understand the meaning of this SVG graphic.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'role-img-alt': {
		statement: 'Screen reader users cannot access the information conveyed by this image.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},

	'link-name': {
		statement: 'Screen reader users cannot determine where this link goes or what it does.',
		affectedGroups: ['blind'],
		severity: 'blocking',
		userStory:
	...
	'button-name': {
		statement: 'Screen reader users cannot determine what action this button performs.',
		affectedGroups: ['blind'],
		severity: 'blocking',
		userStory:
	...
	'link-in-text-block': {
		statement: 'Low vision users may not be able to distinguish links from regular text.',
		affectedGroups: ['low-vision'],
		severity: 'degraded'
	},

	label: {
		statement: 'Screen reader users cannot identify what information to enter in this form field.',
	...
	'input-button-name': {
		statement: 'Screen reader users cannot determine what this form button does.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'select-name': {
		statement: 'Screen reader users cannot understand what this dropdown is for.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	...
	'color-contrast': {
		statement: 'Low vision users and users in bright sunlight cannot read this text.',
	...
	'color-contrast-enhanced': {
		statement: 'Users with moderate vision impairment struggle to read this text.',
		affectedGroups: ['low-vision'],
		severity: 'degraded'
	},

	tabindex: {
		statement: 'Keyboard users experience a confusing, illogical navigation order.',
	...
	'focus-order-semantics': {
		statement: 'Keyboard users cannot navigate this page in a logical sequence.',
		affectedGroups: ['motor', 'blind'],
		severity: 'degraded'
	},
	bypass: {
	...
	'scrollable-region-focusable': {
		statement: 'Keyboard users cannot scroll this content area without using a mouse.',
		affectedGroups: ['motor', 'blind'],
		severity: 'blocking'
	},
	accesskeys: {
	...
	'aria-allowed-role': {
		statement: "Screen reader users receive incorrect information about this element's purpose.",
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-hidden-focus': {
		statement: 'Screen reader users can focus on content they cannot hear, causing confusion.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-hidden-body': {
		statement: 'The entire page is hidden from screen readers, making it completely inaccessible.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'aria-required-attr': {
		statement: "Screen readers cannot properly convey this element's state or behavior.",
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-required-children': {
		statement: 'Screen readers cannot properly navigate this component structure.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-required-parent': {
		statement: 'Screen readers misinterpret this element due to missing parent context.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-roles': {
	...
	'aria-valid-attr': {
		statement: 'Screen readers may ignore or misinterpret this element due to invalid ARIA.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-valid-attr-value': {
		statement: "Screen readers receive incorrect information about this element's state.",
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'aria-progressbar-name': {
		statement: 'Screen reader users cannot tell what this progress indicator is tracking.',
		affectedGroups: ['blind'],
		severity: 'degraded',
		userStory:
	...
	'aria-input-field-name': {
		statement: 'Screen reader users cannot identify the purpose of this input field.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'aria-toggle-field-name': {
		statement: 'Screen reader users cannot determine what this toggle controls.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'aria-command-name': {
		statement: 'Screen reader users cannot determine what action this control performs.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'aria-meter-name': {
		statement: 'Screen reader users cannot understand what this meter is measuring.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},

	'document-title': {
		statement: 'Screen reader users cannot quickly identify which page or tab they are on.',
		affectedGroups: ['blind', 'cognitive'],
		severity: 'degraded',
		userStory:
	...
	'html-lang-valid': {
		statement: "Screen readers use incorrect pronunciation rules for this page's content.",
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'valid-lang': {
	...
	region: {
		statement: 'Screen reader users cannot quickly navigate to different page sections.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},
	landmark: {
		statement: 'Screen reader users must listen to the entire page to find specific content.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},

	'heading-order': {
		statement: "Screen reader users cannot understand the page's content hierarchy.",
		affectedGroups: ['blind', 'cognitive'],
		severity: 'degraded',
		userStory:
	...
	'empty-heading': {
		statement: "Screen reader users hear 'heading' but receive no information about the section.",
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	...
	'td-headers-attr': {
		statement: 'Screen reader users cannot understand which header applies to this data cell.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'th-has-data-cells': {
	...
	'table-duplicate-name': {
		statement: 'Screen reader users cannot distinguish between similar tables on the page.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},
	'scope-attr-valid': {
		statement: 'Screen reader users may misunderstand table header relationships.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},

	'frame-title': {
		statement: 'Screen reader users cannot identify the purpose of this embedded content.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'frame-title-unique': {
		statement: 'Screen reader users cannot distinguish between multiple embedded frames.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},
	...
	listitem: {
		statement: 'Screen reader users receive incorrect information about list structure.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},
	'definition-list': {
		statement: 'Screen reader users cannot understand term-definition relationships.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},
	dlitem: {
		statement: 'Screen reader users receive malformed definition list information.',
		affectedGroups: ['blind'],
		severity: 'inconvenient'
	},

	'duplicate-id': {
		statement: 'Screen readers may skip content or announce it incorrectly due to duplicate IDs.',
		affectedGroups: ['blind'],
		severity: 'degraded'
	},
	'duplicate-id-active': {
		statement: 'Screen readers cannot properly associate labels with form controls.',
		affectedGroups: ['blind'],
		severity: 'blocking'
	},
	'duplicate-id-aria': {
	...
	'nested-interactive': {
		statement: 'Keyboard users may not be able to activate all interactive elements.',
		affectedGroups: ['motor', 'blind'],
		severity: 'blocking'
	},
