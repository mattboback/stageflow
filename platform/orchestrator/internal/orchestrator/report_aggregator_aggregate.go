...
func newReportAggregation(orch *Orchestrator, job *models.Job) *reportAggregation {
...
func (a *reportAggregation) scannerStat(id string) *report.ScannerSummary {
	...
	if a.orch.scannerRegistry != nil {
		if def, ok := a.orch.scannerRegistry.Resolve(id); ok {
...
func (a *reportAggregation) aggregateScanner(ctx context.Context, scannerID string, result *models.ScannerResult) {
	...
	doc, err := a.orch.downloadScanResults(ctx, result.ResultsPath)
	if err != nil {
