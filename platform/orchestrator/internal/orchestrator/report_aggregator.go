...
func (o *Orchestrator) buildAggregatedReport(ctx context.Context, job *models.Job) (string, error) {
	if job == nil {
	...
	agg := newReportAggregation(o, job)
	...
	if err := o.uploadAggregatedReport(ctx, reportKey, report); err != nil {
		return "", err
	}
