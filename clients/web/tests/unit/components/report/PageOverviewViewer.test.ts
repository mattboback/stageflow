...
describe('PageOverviewViewer', () => {
	...
	describe('basic rendering', () => {
		it('renders overlays and triggers selection on click', async () => {
			...
			const marker = container.querySelector("[data-testid='page-overview-marker']");
		...
		it('renders multiple overlay elements for one issue occurrence', () => {
		...
		it('shows empty state when no screenshot URL is provided', () => {
			...
			expect(getByText(/no page overview screenshot available/i)).toBeInTheDocument();
		...
		it('shows empty state when pageOverview dimensions are invalid', () => {
			...
			expect(getByText(/page overview dimensions not available/i)).toBeInTheDocument();
		});
	});
	...
	describe('severity filtering', () => {
		...
		it('filters out issues when severity chip is toggled off', async () => {
			...
			const criticalChip = buttons.find((btn) => btn.tagName.toLowerCase() === 'button');
	...
	describe('keyboard navigation', () => {
		it('responds to keyboard events on the SVG for accessibility', async () => {
			...
			const keyboardTarget = container.querySelector("[data-testid='page-overview-keyboard']");
	...
	describe('accessibility', () => {
		...
		it('renders title elements within rects for tooltips', () => {
			...
			const title = container.querySelector('svg rect[data-testid="page-overview-marker"] title');
