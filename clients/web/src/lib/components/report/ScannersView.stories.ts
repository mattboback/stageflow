...
const report: UnifiedReport = {
	...
	pages: [
		{ id: 'page-home', url: 'https://example.com', issueCount: 2, durationMs: 6500 },
		{ id: 'page-contact', url: 'https://example.com/contact', issueCount: 2, durationMs: 5500 }
	],
	issues: [
		{
			id: 'issue-lh-1',
...
export const SwitchScannerDetails: Story = {
	play: async ({ args, canvasElement }) => {
		...
		const securityHeadersCard = canvas.getByRole('button', { name: /security headers/i });
