...
export const badgeVariants = cva(
	'inline-flex items-center rounded-sm border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-paper',
	{
		variants: {
			variant: {
				default: 'border-transparent bg-accent text-white hover:bg-accent-hover',
				secondary: 'border-transparent bg-surface-muted text-ink hover:bg-surface',
