<script lang="ts">
	...
	const severityItems = $derived([
		{ id: 'critical', label: 'Critical', count: bySeverity.critical, class: 'bg-red-500' },
		{ id: 'serious', label: 'Serious', count: bySeverity.serious, class: 'bg-orange-500' },
		{ id: 'moderate', label: 'Moderate', count: bySeverity.moderate, class: 'bg-amber-500' },
		{ id: 'minor', label: 'Minor', count: bySeverity.minor, class: 'bg-blue-500' },
		{ id: 'info', label: 'Info', count: bySeverity.info ?? 0, class: 'bg-purple-500' }
	]);
</script>
